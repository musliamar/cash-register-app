 ...
 */
public class neuspjesnoDodavanjeProzor extends javax.swing.JFrame {

    /**
     * Creates new form neuspjesnaPrijavaProzor
     */
    public neuspjesnoDodavanjeProzor() {
        initComponents();
        JFrame neuspjesnoDodavanjeProzor = new JFrame();
    ...
    private void initComponents() {
        ...
        neuspjesnoDodavanjeTekst = new javax.swing.JLabel();
        ...
        neuspjesnoDodavanjeTekst.setFont(new java.awt.Font("Segoe UI Semilight", 1, 18)); // NOI18N
        neuspjesnoDodavanjeTekst.setForeground(new java.awt.Color(224, 220, 211));
        neuspjesnoDodavanjeTekst.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Kasa/slike/obrisi.png"))); // NOI18N
        neuspjesnoDodavanjeTekst.setText("Morate popuniti sva polja!");
        neuspjesnoDodavanjeTekst.setToolTipText(null);
        neuspjesnoDodavanjeTekst.setName("Nije uspjelo!"); // NOI18N
        ...
        glavniPanelLayout.setHorizontalGroup(
            ...
            .addGroup(glavniPanelLayout.createSequentialGroup()
                .addGroup(glavniPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(glavniPanelLayout.createSequentialGroup()
                        .addGap(121, 121, 121)
                        .addComponent(neuspjesnoDodavanjeTekst)))
        ...
        neuspjesnoDodavanjeTekst.getAccessibleContext().setAccessibleDescription("Nije uspjelo!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(neuspjesnoDodavanjeProzor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new neuspjesnoDodavanjeProzor().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel neuspjesnoDodavanjeTekst;
