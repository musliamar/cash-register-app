 ...
 */
public class uspjesnoAzuriranje extends javax.swing.JFrame {

    /**
     * Creates new form uspjesnaPrijavaProzor
     */
    public uspjesnoAzuriranje() {
        initComponents();
    ...
    private void initComponents() {
        ...
        uspjesnoUbacenoTekst.setText("Podaci su uspješno ažurirani!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(uspjesnoAzuriranje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new uspjesnoAzuriranje().setVisible(true);
            }
        });
    }
