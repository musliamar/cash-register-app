 ...
 */
public class uspjesnoDodavanjeProzor extends javax.swing.JFrame {

    /**
     * Creates new form uspjesnaPrijavaProzor
     */
    public uspjesnoDodavanjeProzor() {
        initComponents();
        JFrame uspjesnoDodavanjeProzor = new JFrame();
    ...
    private void initComponents() {
        ...
        uspjesnoUbacenoTekst = new javax.swing.JLabel();
        ureduDugme = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Uspješno ubačeno!");
        setBackground(new java.awt.Color(27, 88, 138));
        setName("Uspješno ste ubacili proizvod u bazu!"); // NOI18N
        setUndecorated(true);
        setResizable(false);
        ...
        glavniPanel.setName("Uspješno ste ubacili proizvod u bazu!"); // NOI18N

        uspjesnoUbacenoTekst.setFont(new java.awt.Font("Segoe UI Semilight", 1, 18)); // NOI18N
        uspjesnoUbacenoTekst.setForeground(new java.awt.Color(224, 220, 211));
        uspjesnoUbacenoTekst.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Kasa/slike/uspjesno.png"))); // NOI18N
        uspjesnoUbacenoTekst.setText("Uspješno ste dodali stavku u bazu!");
        uspjesnoUbacenoTekst.setToolTipText(null);
        uspjesnoUbacenoTekst.setName("Uspješno ste ubacili proizvod u bazu!"); // NOI18N
        ...
        glavniPanelLayout.setHorizontalGroup(
            ...
            .addGroup(glavniPanelLayout.createSequentialGroup()
                .addGroup(glavniPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(glavniPanelLayout.createSequentialGroup()
                        .addGap(68, 68, 68)
                        .addComponent(uspjesnoUbacenoTekst)))
        ...
        uspjesnoUbacenoTekst.getAccessibleContext().setAccessibleDescription("Uspješno ste ubacili proizvod u bazu!");
        ...
        glavniPanel.getAccessibleContext().setAccessibleName("Uspješno ste ubacili proizvod u bazu!");
        glavniPanel.getAccessibleContext().setAccessibleDescription("Uspješno ste ubacili proizvod u bazu!");

        getAccessibleContext().setAccessibleName("Uspješno ste ubacili proizvod u bazu!");
        getAccessibleContext().setAccessibleDescription("Uspješno ste ubacili proizvod u bazu!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(uspjesnoDodavanjeProzor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new uspjesnoDodavanjeProzor().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel uspjesnoUbacenoTekst;
