 ...
 */
public class neuspjesnoBrisanjeSaRacuna extends javax.swing.JFrame {

    /**
     * Creates new form uspjesnaPrijavaProzor
     */
    public neuspjesnoBrisanjeSaRacuna() {
        initComponents();
        JFrame neuspjesnoBrisanjeSaRacuna = new JFrame();
    ...
    private void initComponents() {
        ...
        neuspjesnoObrisanoTekst.setText("Označite proizvod koji želite da obrišete sa računa!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(neuspjesnoBrisanjeSaRacuna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new neuspjesnoBrisanjeSaRacuna().setVisible(true);
            }
        });
    }
